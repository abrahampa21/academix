...
<body>
  <header>
    <nav class="nav-bar">
      ...
      <i class="fa-solid fa-bell bell-icon" onclick="notificacionAlumno()"></i>
      <!--Menú responsive-->
  ...
  <aside class="menu-side" id="menu-side">
    ...
    <div class="exit">
      <a href="index.html" title="Salir" onclick="exit()" name="salir">
