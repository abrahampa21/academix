...
$para = 'melanieatr2005@gmail.com'. ', '; // atención a la coma
...
<body>
    ...
    <div style="text-align:center; background-color:#ccc">
        ...
        <h3>'.$codigo.'</h3>
        <p> <a 
            href="http://127.0.0.1/recu/Sistema-de-login-y-registro-con-auth-token-main/reset.php?email='.$email.'&token='.$token.'"> 
